        ...
        klass.class_eval do
          ...
          def self.define_state_machine!
            ...
            state_machine :state, initial: :cart, use_transactions: false, action: :save_state do
              ...
              if states[:single_step_checkout]
                before_transition to: :complete do |order|
                  ...
                  before_transition from: :single_step_checkout, do: :address_callbacks
                  before_transition from: :single_step_checkout, do: :delivery_callbacks
                  before_transition from: :single_step_checkout, do: :payment_callbacks
                  after_transition to: :complete, do: :persist_user_credit_card
                  before_transition from: :single_step_checkout, do: :apply_free_shipping_promotions
                end
              end
              ...
              after_transition from: any - :cart, to: any - [:single_step_checkout] do |order|
                order.update_totals
          ...
          def payment_callbacks
            set_shipments_cost
            create_tax_charge!
            assign_default_credit_card
          end

          def address_callbacks
            create_tax_charge!
            assign_default_addresses!
            persist_user_address!
          end

          def delivery_callbacks
